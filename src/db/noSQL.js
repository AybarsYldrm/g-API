...
class NoSQL {
  constructor(rootDir, { idFactory = null } = {}) {
  ...
  async insert(collection, doc) {
    ...
    const operationCode = typeof schema.operationCode === 'number' ? schema.operationCode : 0;
    const generatedId = this.idFactory.generate(operationCode);
